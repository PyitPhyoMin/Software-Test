...
// Declare an array to be used to store patient's name.[PyitPhyo]
let patientNames = [];

function addPatient(patientName){
    // Task 2: Add code here
    // Add Patient Name to the array.[PyitPhyo]
    patientNames.push(patientName);
    
}

// Task 3: Add code here
// Print all patient's name stored in the array.[PyitPhyo]
